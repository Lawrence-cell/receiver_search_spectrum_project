...
#include "../../QtApplication1/mymessagebox.h"
...
QT_MOC_LITERAL(1, 13, 10), // "btnchicked"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 3), // "num"
QT_MOC_LITERAL(4, 29, 27), // "on_btn_system_close_clicked"
QT_MOC_LITERAL(5, 57, 25), // "on_btn_mbox_btn01_clicked"
QT_MOC_LITERAL(6, 83, 25) // "on_btn_mbox_btn02_clicked"

    },
    "MyMessageBox\0btnchicked\0\0num\0"
    "on_btn_system_close_clicked\0"
    "on_btn_mbox_btn01_clicked\0"
...
void MyMessageBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->btnchicked((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->on_btn_system_close_clicked(); break;
        case 2: _t->on_btn_mbox_btn01_clicked(); break;
        case 3: _t->on_btn_mbox_btn02_clicked(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (MyMessageBox::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyMessageBox::btnchicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyMessageBox::btnchicked(int _t1)
{
